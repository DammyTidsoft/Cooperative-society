    ...
    <div class="row">
      <div class="col-md-3 footer1 d-flex wow bounceInLeft" data-wow-delay=".25s">
        <div class="d-flex flex-wrap align-content-center"> <a href="#"><img src="images/logo.png" alt="logo" /></a>
          ...
          <p>&copy; 2022 Al-Kawthar. All rights reserved.<br> Design by <a href="https://www.tidsoftitsolution.wordpress.com" target="_blank">Tidsoft</a>.</p>
        </div>
      </div>
      <div class="col-md-6 footer2 wow bounceInUp" data-wow-delay=".25s" id="contact">
        <div class="form-box">
          ...
          <table class="table table-responsive d-table">
            ...
            <tr>
              <td colspan="2"><input type="text" class="form-control pl-0" id="user" name="user" placeholder="USERNAME" /></td>
            </tr>
            <tr>
              <td colspan="2"></td>
            </tr>
            <tr>
              <td colspan="2"><input type="PASSWORD" class="form-control pl-0" id="pass" name="pass" placeholder="PASSWORD" /></td>
            </tr>
            <tr>
              <td colspan="2"></td>
            </tr>
            <tr>
              <td colspan="2" class="text-center pl-0"><button type="submit" class="btn btn-dark">LOGIN</button></td>
            </tr>
            </form>
          </table>
        </div>
